 ...
 *
 */
public class Auton_MiddleStartDeliverSwitchStraight extends CommandGroup {

    public Auton_MiddleStartDeliverSwitchStraight() {
    	...
    	//addSequential(new AutonDriveAngleTimePower(0,1.15,.5));
    	//addSequential(new AutonDriveAngleTimePower(0,1.5,.12));
